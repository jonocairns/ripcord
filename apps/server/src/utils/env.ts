...
const SERVER_VERSION = typeof SHARKORD_BUILD_VERSION !== 'undefined' ? SHARKORD_BUILD_VERSION : '0.0.0-dev';

const BUILD_DATE = typeof SHARKORD_BUILD_DATE !== 'undefined' ? SHARKORD_BUILD_DATE : 'dev';
...
export { BUILD_DATE, IS_DEVELOPMENT, IS_DOCKER, IS_PRODUCTION, IS_TEST, SERVER_VERSION, SHARKORD_MEDIASOUP_BIN_NAME };
