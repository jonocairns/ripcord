...
import { DRIZZLE_PATH, INTERFACE_PATH, MEDIASOUP_PATH, SRC_MIGRATIONS_PATH } from '../helpers/paths';
...
const loadEmbeds = async () => {
	...
	try {
		...
		const mediasoupPath = path.join(MEDIASOUP_PATH, getExecutableName('mediasoup-worker'));
