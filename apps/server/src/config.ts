...
if (legacyAnnouncedAddress) {
	config = {
		...
		webRtc: {
			...
			ipv4: {
				...config.webRtc.ipv4,
				announcedAddress: config.webRtc.ipv4.announcedAddress || legacyAnnouncedAddress,
			},
			ipv6: {
				...config.webRtc.ipv6,
				announcedAddress: config.webRtc.ipv6.announcedAddress || legacyAnnouncedAddress,
			},
		},
	};
}
