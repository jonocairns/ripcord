...
const generateFileToken = (fileId: number, channelAccessToken: string): string => {
...
const verifyFileToken = (fileId: number, channelAccessToken: string, providedToken: string): boolean => {
