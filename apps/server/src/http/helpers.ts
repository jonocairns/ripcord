...
const getHeaderNumber = (value: string | string[] | undefined): number | undefined => {
...
const getJsonBody = async <T = unknown>(req: http.IncomingMessage, options: TGetJsonBodyOptions = {}): Promise<T> => {
