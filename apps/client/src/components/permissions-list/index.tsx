import { type Permission, permissionLabels } from '@sharkord/shared';
...
const PermissionsList = memo(
	({
		...
		const displayPermissions = maxDisplay ? permissions.slice(0, maxDisplay) : permissions;

		const remainingCount = maxDisplay && permissions.length > maxDisplay ? permissions.length - maxDisplay : 0;
