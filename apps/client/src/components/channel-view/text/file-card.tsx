...
import { File, FileImage, FileMusic, FileText, FileVideo, Trash } from 'lucide-react';
...
const FileCard = ({ name, size, extension, href, onRemove }: TFileCardProps) => {
	...
	return (
		...
		>
			...
			<div className="flex flex-1 flex-col overflow-hidden">
				<span className={cn('truncate text-sm font-medium text-foreground transition-colors duration-200')}>
					{name}
				</span>
