...
const MessagesGroup = memo(({ group }: TMessagesGroupProps) => {
	...
	return (
		<div className="min-w-0 max-w-dvw" onMouseLeave={() => setHoveredMessageId(undefined)}>
			<div
				className={cn(
				...
				onMouseEnter={isSingleMessageGroup ? () => setHoveredMessageId(firstMessage.id) : undefined}
			>
				<div onMouseEnter={isSingleMessageGroup ? () => setHoveredMessageId(firstMessage.id) : undefined}>
