			...
			<Popover>
				...
				<PopoverContent align="end" side="bottom" className="w-56 p-3" onClick={(e) => e.stopPropagation()}>
					<div className="space-y-3">
						<div className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Volume</div>
						...
						{streamStats && (
							<>
								...
								<div className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Stream Info</div>
								<div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
									...
									{streamStats.frameRate !== null && (
										<>
											...
											<span className="text-right font-medium">{Math.round(streamStats.frameRate)} fps</span>
										</>
									)}
