...
const useStreamStats = (videoRef: React.RefObject<HTMLVideoElement | null>, videoStream: MediaStream | undefined) => {
				...
				try {
					...
					for (const stat of report.values()) {
						if (stat.type === 'inbound-rtp' && stat.kind === 'video') {
							...
							if (prevBytesRef.current !== null && prevTimestampRef.current !== null) {
