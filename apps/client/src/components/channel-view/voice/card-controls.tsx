...
const CardControls = memo(({ children, className }: TCardControlsProps) => {
	return (
		<div
			className={cn(
				'absolute top-3 right-3 z-20 flex items-center gap-1 rounded-full border border-white/15 bg-black/65 p-1 text-white opacity-0 shadow-lg backdrop-blur-md transition-opacity group-hover:opacity-100 group-focus-within:opacity-100',
