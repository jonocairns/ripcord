...
const voiceSurfaceVariants = cva('rounded-2xl border border-white/8', {
	variants: {
		variant: {
			card: 'bg-voice-surface/88 shadow-[0_10px_32px_rgb(0_0_0/0.38)]',
			dock: 'bg-voice-surface/74 shadow-[0_18px_40px_rgb(0_0_0/0.28)] backdrop-blur-xl',
			controls: 'bg-voice-surface/88 shadow-2xl backdrop-blur-xl',
		},
		clip: {
