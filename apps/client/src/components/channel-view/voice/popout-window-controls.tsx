...
import { type ChangeEvent, type CSSProperties, memo, type ReactNode } from 'react';
...
const PopoutWindowControls = memo(
	({ visible, isFullscreen, onToggleFullscreen, children }: TPopoutWindowControlsProps) => {
		return (
			<div
				style={{
					position: 'absolute',
...
export { POPOUT_BUTTON_STYLE, POPOUT_ENABLE_AUDIO_BUTTON_STYLE, PopoutVolumePanel, PopoutWindowControls };
