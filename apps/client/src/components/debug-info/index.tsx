...
const DebugInfo = memo(() => {
	useStrictEffect(() => {
		...
		console.log('%cVersion: %s', 'font-size: 16px; font-weight: bold;', VITE_APP_VERSION);
		console.log('%cEnvironment: %s', 'font-size: 16px; font-weight: bold;', import.meta.env.MODE);
		console.log(
