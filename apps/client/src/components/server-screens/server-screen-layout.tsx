...
const ServerScreenLayout = memo(({ close, title, children }: TServerScreenLayoutProps) => {
	return (
		<div className="flex min-h-0 h-full flex-col bg-background text-foreground dark">
