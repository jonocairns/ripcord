				...
				<div className="flex items-center justify-between">
					<div className="space-y-1">
						<CardTitle className="flex items-center gap-2 text-lg">
							<span className="h-3 w-3 rounded-full" style={{ backgroundColor: selectedRole.color }} />
							{selectedRole.name}
						</CardTitle>
			...
			<CardContent className="flex-1 space-y-6 overflow-y-auto py-6">
				{selectedRole.isDefault && (
					<Alert variant="default">
						<Star />
						<AlertDescription>
							This is the default role. New members will be assigned this role upon joining.
						</AlertDescription>
					</Alert>
				)}
				...
				{isOwnerRole && (
					<Alert variant="default">
						<Info />
						<AlertDescription>
							This is the owner role. This role has all permissions and cannot be deleted or have its permissions
							changed.
						</AlertDescription>
					</Alert>
				)}
				...
				<div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_240px]">
					...
					<div className="space-y-2">
						...
						<div className="flex gap-2">
							<Input id="role-color" className="h-10 w-14 flex-none p-1" {...r('color', 'color')} />
				...
				<PermissionList
					...
					setPermissions={(permissions) => onChange('permissions', permissions)}
				/>
			</CardContent>
