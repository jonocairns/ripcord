		...
		>
			<div className="flex items-center min-w-0">
				<div className="flex items-center gap-2 min-w-0">
					<code className="text-xs font-mono bg-muted px-2 py-1 rounded truncate">{invite.code}</code>
					<Button variant="ghost" size="icon" className="h-6 w-6 flex-shrink-0" onClick={handleCopyCode}>
			...
			<div className="flex items-center text-muted-foreground">
				<span
					...
					title={invite.expiresAt ? format(invite.expiresAt, 'PPP p') : undefined}
				>
					{expiresText}
				</span>
			</div>
