	...
	return (
		<Card className="border-dashed">
			<CardContent className="flex h-full flex-col items-center justify-center gap-3 py-16 text-center">
				<div className="bg-muted flex h-14 w-14 items-center justify-center rounded-full text-3xl">😀</div>
				<h3 className="text-lg font-medium text-foreground">Upload Custom Emojis</h3>
