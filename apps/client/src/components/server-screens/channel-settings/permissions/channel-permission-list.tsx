import { ChannelPermission, channelPermissionDescriptions, channelPermissionLabels } from '@sharkord/shared';
...
const ChannelPermissionItem = memo(({ permission, enabled, onChange }: TChannelPermissionItemProps) => {
	return (
		<div className="flex items-center justify-between">
			<div className="flex flex-col">
				<Label>{channelPermissionLabels[permission]}</Label>
				<span className="text-sm text-muted-foreground">{channelPermissionDescriptions[permission]}</span>
			</div>
...
const ChannelPermissionList = memo(({ permissions, onTogglePermission }: TChannelPermissionListProps) => {
