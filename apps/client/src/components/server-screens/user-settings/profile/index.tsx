...
const Profile = memo(() => {
	...
	}, [ownPublicUser, setError, setTrpcErrors, setValues, values.bio, values.bannerColor, values.name]);
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>Update your personal information and settings here.</CardDescription>
			</CardHeader>
			<CardContent className="space-y-6">
				<section className="space-y-4">
					<div className="max-w-2xl space-y-4">
						...
						<div className="space-y-2">
							<Label>Bio</Label>
							<Textarea placeholder="Tell us about yourself..." className="min-h-24" {...r('bio')} />
						</div>
					</div>
				</section>
				...
				<section className="space-y-4">
					<div className="space-y-1">
						...
						<p className="text-sm text-muted-foreground">Manage your avatar and banner image.</p>
					</div>
