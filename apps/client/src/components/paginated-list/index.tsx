...
const PaginatedList = memo(PaginatedListComponent) as <T>(props: TPaginatedListProps<T>) => React.ReactElement;

(PaginatedList as unknown as { displayName: string }).displayName = 'PaginatedList';
