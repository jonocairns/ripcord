	...
	return (
		<div className="py-2 px-1 border-b border-border last:border-0 bg-secondary/50 rounded-md">
			<div className="flex items-center justify-between">
				...
				<Button variant="ghost" size="sm" onClick={onOpen} className="flex-shrink-0 ml-2">
...
const Links = memo(() => {
	...
	const searchFilter = useCallback((url: string, term: string) => url.toLowerCase().includes(term.toLowerCase()), []);
