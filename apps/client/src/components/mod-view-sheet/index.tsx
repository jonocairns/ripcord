...
import { ModViewContext, type ModViewScreen, type TModViewContext } from './context';
...
const ContentWrapper = memo(({ userId }: TContentWrapperProps) => {
	const [currentView, setCurrentView] = useState<ModViewScreen | undefined>(undefined);
	const { user, loading, refetch, logins, files, messages } = useAdminUserInfo(userId);
