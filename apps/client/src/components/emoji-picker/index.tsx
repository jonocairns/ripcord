...
const EmojiPicker = memo(({ children, onEmojiSelect, defaultTab = 'native' }: TEmojiPickerProps) => {
	...
	return (
		<Popover open={open} onOpenChange={setOpen}>
			...
			<PopoverContent className="w-[320px] p-0 h-[400px]" align="start" sideOffset={8}>
				<Tabs defaultValue={defaultTab} className="h-full flex flex-col">
					...
					<TabsContent value="custom" className="flex-1 mt-0 min-h-0">
						<CustomEmojiTab customEmojis={customEmojis} onEmojiSelect={handleEmojiSelect} />
					</TabsContent>
				</Tabs>
			</PopoverContent>
		</Popover>
