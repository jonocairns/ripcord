				...
				<div className="flex items-start gap-2">
					...
					<div className="flex-1 min-w-0">
						{response.success ? (
							...
							<div>
								<p className="font-medium text-sm text-red-900 dark:text-red-100 mb-1">Command failed</p>
								<p className="text-sm text-red-800 dark:text-red-200">{response.error}</p>
							</div>
						)}
					</div>
				</div>
