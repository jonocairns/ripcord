...
const CreateInviteDialog = memo(({ refetch, close, isOpen }: TCreateInviteDialogProps) => {
		...
		<Dialog open={isOpen}>
			<DialogContent onInteractOutside={close} close={close}>
				<DialogHeader>
					...
					<DialogDescription>Create a new invitation link for users to join the server.</DialogDescription>
				</DialogHeader>
				...
				<div className="space-y-4">
					...
					<Group label="Expires in" description="Leave empty for no expiration.">
