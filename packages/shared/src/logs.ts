...
type TEmptyActivityLogDetails = Record<never, never>;
...
export type TActivityLogDetailsMap = {
	[ActivityLogType.SERVER_STARTED]: TEmptyActivityLogDetails;
	...
	[ActivityLogType.USER_LEFT]: TEmptyActivityLogDetails;
	[ActivityLogType.USER_UPDATED_PASSWORD]: TEmptyActivityLogDetails;
	...
	[ActivityLogType.USER_ENABLED_2FA]: TEmptyActivityLogDetails;
	[ActivityLogType.USER_DISABLED_2FA]: TEmptyActivityLogDetails;
	[ActivityLogType.USER_USED_RECOVERY_CODE]: {
		remainingCodes: number;
	};
	[ActivityLogType.USER_REGENERATED_RECOVERY_CODES]: TEmptyActivityLogDetails;
	// -------------------- ROLES --------------------
