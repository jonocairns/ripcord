...
export const userByIdSelector = (state: IServerState, userId: number) => state.users.find((user) => user.id === userId);

export const isOwnUserSelector = (state: IServerState, userId: number) => ownUserIdSelector(state) === userId;
